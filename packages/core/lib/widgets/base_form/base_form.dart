      ...
      children: [
        ...
        Theme(
          data: isDarkMode(context)
              ? themeDataDark.copyWith(cardColor: neutralWhite)
              : themeDataLight,
          child: TextFormField(
            key: widget.keyForm,
            ...
            decoration: InputDecoration(
              ...
              prefixIcon: widget.prefixIcon != null && widget.prefixIcon!.isNotEmpty
                  ...
                  : widget.prefix,
              suffixIcon: widget.suffixIcon != null && widget.suffixIcon!.isNotEmpty
                  ? Padding(
                      padding: const EdgeInsets.all(12),
                      child: InkWell(
                        ...
                        child: SvgPicture.asset(
                          widget.suffixIcon!,
                          colorFilter:
                              widget.enabled ?? true ? colorFilterblue700 : colorFilterGray500,
                        ),
                      ),
                    )
                  : widget.suffix,
              prefixIconConstraints: widget.prefixIcon != null && widget.prefixIcon!.isNotEmpty
                  ...
                  : null,
              suffixIconConstraints: widget.suffixIcon != null && widget.suffixIcon!.isNotEmpty
                  ? const BoxConstraints(
                      maxWidth: 40,
                      maxHeight: 40,
                      minHeight: 40,
              ...
              enabledBorder: OutlineInputBorder(
                borderSide:
                    BorderSide(color: isDarkMode(context) ? mediumEmphasis : gray300, width: 1),
