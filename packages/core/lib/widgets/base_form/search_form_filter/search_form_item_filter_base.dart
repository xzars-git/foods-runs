...
class SearchFormItemFilterBase extends StatefulWidget {
  ...
  final Function(Suggestion) onSelectedSuggestion;
  ...
  const SearchFormItemFilterBase({
    super.key,
  ...
  @override
  State<SearchFormItemFilterBase> createState() => _SearchFormItemFilterBaseState();
}

class _SearchFormItemFilterBaseState extends State<SearchFormItemFilterBase> {
  @override
  void initState() {
    super.initState();
  }
    ...
    return Expanded(
      ...
      child: Builder(
        builder: (context) {
          ...
          final hasSuggestions = searchKeyModel?.suggestion.length != 1 ? true : false;
          ...
          return hasSuggestions
              ...
              : BaseDropdownWithSearchFormV3(
                  ...
                  hintText: "Masukan input isian...",
                  onSuggestionSelected: widget.onSelectedSuggestion,
                  suggestionOptions: searchKeyModel?.suggestion ?? [],
                );
        },
      ),
